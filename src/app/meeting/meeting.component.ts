...
export class MeetingComponent {
  ...
  publisher: StreamManager | undefined; // Local
  ...
  joinSession() {
    ...
    this.session.on('streamCreated', (event: StreamEvent) => {
      ...
      let subscriber: Subscriber | undefined = this.session?.subscribe(
        event.stream,
        undefined
      );
    ...
    this.getToken().then((token) => {
      ...
      this.session
        ...
        .then(() => {
          ...
          let publisher: Publisher | undefined = this.OV?.initPublisher(
            undefined,
            {
